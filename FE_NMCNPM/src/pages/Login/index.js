    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('form')}>
                <h3>Đăng nhập</h3>
                <form className={cx('form__input')} onSubmit={onSubmit}>
                    ...
                    />
                    {error && <span className={cx('message')}>{message}</span>}
                ...
                <button className={cx('login-by', 'face')}>
                    <box-icon
                        type="logo"
                        name="facebook"
                        color="#fff"
                ...
                <button className={cx('login-by', 'google')}>
                    <box-icon
                        name="google"
                        type="logo"
                        color="#fff"
